...
static TCHAR g_lpPackageName[1024] = L"Negotiate";
...
int main()
{
    ...
    while (TRUE)
    {
        ...
        // VMagriplis 2023-01-20: the original sample code did not account 
        // for TCHAR size, causing heap corruption when the username is retrieved.
        pUserName = (PCHAR)malloc(cbUserName*sizeof(TCHAR));
