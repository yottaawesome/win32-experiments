...
/* DoTheAddition */
    { 
    /* DoTheAddition */      /* procedure DoTheAddition */
...
/* SetSecondNumber */
    { 
    /* SetSecondNumber */      /* procedure SetSecondNumber */
        (NDR64_UINT32) 524611 /* 0x80143 */,    /* auto handle */ /* IsIntrepreted, [object], HasReturn */
        (NDR64_UINT32) 24 /* 0x18 */ ,  /* Stack size */
        (NDR64_UINT32) 8 /* 0x8 */,
        (NDR64_UINT32) 8 /* 0x8 */,
...
#pragma code_seg(".orpc")
static const FormatInfoRef IAdd_Ndr64ProcTable[] =
    {
    &__midl_frag5,
    &__midl_frag5,
    &__midl_frag8
...
static const MIDL_SYNTAX_INFO IAdd_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    ...
    0,
    0 ,
    (unsigned short *) &IAdd_Ndr64ProcTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IAdd_ProxyInfo =
    ...
    2,
    (MIDL_SYNTAX_INFO*)IAdd_SyntaxInfo
...
static const MIDL_SERVER_INFO IAdd_ServerInfo = 
    ...
    0,
    IAdd__MIDL_ProcFormatString.Format,
    (unsigned short *) &IAdd_FormatStringOffsetTable[-3],
    0,
...
EXTERN_C const ExtendedProxyFileInfo IAdd_ProxyFileInfo = 
{
