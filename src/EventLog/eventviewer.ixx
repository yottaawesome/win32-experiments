...
// Adapted from https://learn.microsoft.com/en-us/windows/win32/eventlog/querying-for-event-source-messages
export namespace TestB
{
    constexpr auto PROVIDER_NAME = L"MyEventProvider";
    constexpr auto RESOURCE_DLL = L"<path>\\Provider.dll";
    constexpr auto MAX_TIMESTAMP_LEN = 23 + 1;   // mm/dd/yyyy hh:mm:ss.mmm
    constexpr auto MAX_RECORD_BUFFER_SIZE = 0x10000;  // 64K
