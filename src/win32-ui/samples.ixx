...
export namespace ObjectOrientedControl
{
    ...
    class Control
    {
        ...
        void Init(Win32::HWND parent, const Win32::DWORD x, const Win32::DWORD y, const Win32::DWORD width, const Win32::DWORD height)
        {
            ...
            if (not m_control.Handle)
                throw Error::Win32Error("Failed creating button.", Win32::GetLastError());
    ...
    class Window
    {
        ...
        HWND Init()
        {
            ...
            if (not Win32::RegisterClassExW(&wc))
                throw Error::Win32Error("Failed registering class", Win32::GetLastError());
            ...
            if (not hwnd)
                throw Error::Win32Error("Failed creating window", Win32::GetLastError());
