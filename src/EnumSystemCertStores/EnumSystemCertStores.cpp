// Adapted from https://learn.microsoft.com/en-us/windows/win32/seccrypto/example-c-program-listing-system-and-physical-stores
#include <stdio.h>
#include <windows.h>
#include <Wincrypt.h>
...
int main()
{
    ...
    PhyStoreInfo.pszOpenStoreProvider = LPSTR("System"); //sz_CERT_STORE_PROV_SYSTEM_W;
    pszTestName = "Enum";
